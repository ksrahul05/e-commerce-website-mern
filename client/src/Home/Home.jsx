...
export default function Home() {
  ...
  async function fetchProducts(){
    await axios.get("https://e-commerce-website-mern-ka4q.onrender.com/api/product")
      .then((res)=>{
        console.log(res)
  ...
  async function addCart(productId){
    ...
    try{
      await axios.post("https://e-commerce-website-mern-ka4q.onrender.com/api/cart/add",{productId},{
