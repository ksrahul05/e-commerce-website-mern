...
export default function Cart() {
    ...
    async function fetchCartProducts() {
        await axios.get("https://e-commerce-website-mern-ka4q.onrender.com/api/cart", {
    ...
    async function removeFromCart(productId){
        try{
            await axios.delete(`https://e-commerce-website-mern-ka4q.onrender.com/api/cart/remove/${productId}`,{
                headers:{Authorization:`Bearer ${user.token}`}
            })
            .then((res)=>{
