...
export default function Register() {
    ...
    function handleSubmit(e){
        ...
        axios.post("https://e-commerce-website-mern-ka4q.onrender.com/api/auth/signup",formData)
            .then((res)=>{
    ...
    return (
        <div>
            <form>
                ...
                <div>
                    <input type="text" placeholder='Mobile Number' name="mobilenumber" onChange={handleChange}/>
                </div>
